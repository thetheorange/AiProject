...
from SettingWindow import SettingWidget
...
class MainChatWindow(SplitFluentWindow):
    ...
    def __init__(self):
        ...
        # )
        self.photohpath2=r'../Asserts/icons/user.png'
        self.navigationInterface.addWidget(
            routeKey='insertion',
        ...
        self.addSubInterface( self.maskwidget ,FluentIcon.ROBOT , '面具', NavigationItemPosition.TOP)
        self.SettingWidget= SettingWidget()
        self.addSubInterface(self.SettingWidget, FIF.SETTING, '设置', NavigationItemPosition.BOTTOM)
